...
| Pillar | What it is |
|--------|-----------|
| **Manifest** | Your project's constitution — the why |
| **Skills** | Reusable procedures — the how |
| **Rules** | Quality criteria — the standard |
| **Memory** | Persistent brain — what we learned |

The method is free. The tools are open source. Your data belongs to you.
